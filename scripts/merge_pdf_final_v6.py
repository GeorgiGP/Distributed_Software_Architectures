...
def main():
    ...
    section_8 = "/Users/I764233/uni/RSA/docs/section_8_with_graphs.pdf"
    section_9 = "/Users/I764233/uni/RSA/docs/section_9_updated.pdf"
    output_pdf = "/Users/I764233/uni/RSA/P2P_Dynamic_Balancing_FINAL_v6.pdf"
    ...
    # Section 8 with graphs (replaces pages 22-24)
    for page in PdfReader(section_8).pages:
        writer.add_page(page)
    print("Added section 8 (with graphs)")
    ...
    final_pages = len(PdfReader(output_pdf).pages)
    print(f"\nOutput: {output_pdf}")
