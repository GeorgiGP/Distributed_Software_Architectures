#!/usr/bin/env python3
"""
Merge PDFs: replace section 6.3 and section 7.6 with full threshold analysis.
"""
...
def main():
    ...
    section_6_3 = "/Users/I764233/uni/RSA/docs/section_6_3_full.pdf"
    section_7_6 = "/Users/I764233/uni/RSA/docs/section_7_6_full.pdf"
    output_pdf = "/Users/I764233/uni/RSA/P2P_Dynamic_Balancing_FINAL_v3.pdf"
    ...
    # 14-15: pages 15-16 (section 6.3) - REPLACE
    # 16-18: pages 17-19 (keep)
    # 19-20: pages 20-21 (section 7.6) - REPLACE
    # 21+: pages 22+ (keep)
    ...
    # Insert section 6.3 (replaces pages 15-16)
    ...
    # Insert section 7.6 (replaces pages 20-21)
